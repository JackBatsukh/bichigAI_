...
export default function HeroSection() {
  return (
    <section className="flex flex-col gap-[20px] items-center justify-center text-center  my-[250px] h-[85vh]">
      ...
      <button className="mt-2 px-8 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow-lg">
        Эхлэх
      </button>
    </section>
  );
